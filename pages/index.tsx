...
const Home: NextPage = () => {
  return (
    <div className="min-h-screen grid gap-12 desktop:gap-0 text-primary-medium-dark max-w-mobile desktop:max-w-desktop">
      <Head>
        <title>Frontend Mentor | Tip calculator app</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <header className="place-self-center mt-12 mb-10 desktop:m-0">
        <h1>
